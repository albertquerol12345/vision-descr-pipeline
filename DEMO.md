...
```bash
# The repo includes sample images
ls images/sample/
# ring_gold.jpg necklace_silver.jpg bracelet_leather.jpg

# Run on 3 sample images
...
✓ ring_gold.jpg → 89 words
✓ necklace_silver.jpg → 94 words
✓ bracelet_leather.jpg → 82 words
...
The repo includes 3 sample jewelry images for testing:

```bash
ls images/sample/
├── ring_gold.jpg        # Classic gold ring
├── necklace_silver.jpg  # Modern silver necklace  
└── bracelet_leather.jpg # Casual leather bracelet
```
